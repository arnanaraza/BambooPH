### MAIN FUNCTION TO TRAIN A RANDOM FOREST REGRESSION MODEL FOR BAMBOO COVER MAPPING
...
plot(pred)
writeRaster(pred, filename="bambooCover_100m.tif", overwrite=TRUE)

#Upland and lowland statistics
lowland <- pred[pred<=17]
upland <- pred[pred>17]
sum(lowland/100)
sum(upland/100)
